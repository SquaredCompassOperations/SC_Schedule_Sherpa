...
const NARRATIVE_PROMPTS: Record<string, string> = {
  ...
  "epa-narrative":
    "Draft an Economic Price Adjustment (EPA) narrative for a GSA MAS Schedule. Anchor every element to the GSA Pricing Terms Attachment (Refresh 32) and cite GSAM 538.270-4 subsection numbers explicitly. The Offeror has elected a specific EPA mechanism — use the mechanism provided in the master intake context (EPA Mechanism field). Map the elected mechanism to the corresponding GSAM 538.270-4 subsection: (a)(1) fixed escalation rates → Fixed Ceiling; (a)(2) market index or other basis → Market Indicator (e.g., BLS Employment Cost Index); (a)(3) established pricing such as the contractor's published Commercial Price List or commercial catalog → Commercial Price List; (a)(4) unforeseeable significant changes in market conditions (always incorporated by reference — no separate election required). Address: the elected mechanism and its GSAM 538.270-4 citation; basis for adjustment and supporting documentation submitted with each EPA request; per-period and aggregate caps; frequency (annual on the anniversary date of contract award unless otherwise stated) and notice requirements; whether the method is consistent with the Offeror's commercial practices; compliance with GSAR 552.216-70 / I-FSS-969 escalation limitations. Tone: formal, federal, third person.",
